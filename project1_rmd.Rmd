...
vif_1 <- lm(Deaths~Animal_Fats+Cereals+Oilcrops+Pulses + Vegetable_Oils+Obesity, data=no_unusual_observations)
vif(vif_1)
```
...
```{r}
new_model_3 <- lm(Deaths~Animal_Fats+Cereals+Oilcrops+Pulses + Vegetable_Oils+Obesity, data=no_unusual_observations)
