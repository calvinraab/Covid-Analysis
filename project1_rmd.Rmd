...
library(stargazer)
stargazer(mod1, mod2, mod3, mod4, object.names = TRUE, title = "Regression Models without (1) High Leverage, (2) Influential, (3) Outlier (4) All Unusual Oberservations", type = 'latex')
```

```{r}
# Re-estimate the models without unusual observations
