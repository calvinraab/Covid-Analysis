...
```{r newtable, results = "asis"}
summary(new_model_4)
tidy(new_model_4_adjusted)
library(stargazer)

stargazer(backAIC, new_model_1, new_model_2, new_model_3, new_model_4, object.names = TRUE, 
          title = "Regression Model Results", column.labels = 
            c("BackAIC", "Model 1", "Model 2", 
              "Model 3", "Model 4"), type = 'latex', 
          header = FALSE, no.space = TRUE, single.row = TRUE, 
          font.size = "small", column.sep.width = "-15pt")
```
